# сюда сложим венгерский метод, он слишком длинный
# m = ((int(token) for token in line.split(";")) for line in open('input_1.csv', "r"))
# with open('input_1.csv', 'r') as f:
...
rd = np.random.RandomState(10000)
task_matrix = rd.randint(30, 100, size=(5, 5))
